...
void Config::handleClientMaxBodySize(const std::string& value, ServerBlock& server) {
    server.clientMaxBodySize = ConfigUtils::parseSize(value);
}

void Config::handleLocationRoot(const std::string& value, LocationBlock& location) {
    if (!ConfigUtils::isValidPath(value)) {
...
void Config::handleLocationIndex(const std::string& value, LocationBlock& location) {
...
void Config::handleUploadEnable(const std::string& value, LocationBlock& location) {
...
void Config::handleLocationClientMaxBodySize(const std::string& value, LocationBlock& location) {
