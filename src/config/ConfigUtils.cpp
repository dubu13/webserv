...
std::vector<std::string> ConfigUtils::extractServerBlocks(const std::string& content) {
...
std::pair<std::string, std::string> ConfigUtils::parseDirective(const std::string& line) {
    ...
    std::string_view value_view = HttpUtils::trimWhitespace(trimmed_view.substr(space_pos + 1));
...
std::vector<std::string> ConfigUtils::parseMultiValue(const std::string& value) {
...
std::map<int, std::string> ConfigUtils::parseErrorPages(const std::string& value) {
